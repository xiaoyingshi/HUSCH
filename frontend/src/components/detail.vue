			...
			<el-col>
							...
							<el-row :gutter="20" style="margin-top: 50px">
								<el-col :span="24">
									...
									>
										<el-image
											v-for="url in img"
											:key="`data:image/png;base64,${url}`"
											:src="`data:image/png;base64,${url}`"
											lazy
										></el-image>
									</div> -->
									<!-- <div style='overflow-x: auto; width:400px;height:400px;'  v-if="show_gene_umap">
                                        <el-col :span="12">
                                            <el-image class="image3" :src="`data:image/png;base64,${img}`" />
                                        </el-col>
                                    </div> -->
                                      <div id="imgdiv" class="scrollable" v-if="show_gene_umap">
                                        <img class="image3" :src="`data:image/png;base64,${img}`" />
                                    </div>
								</el-col>
							</el-row>
						</el-card>
              ...
              <el-option
                ...
                :value="item">
					...
					<el-tab-pane>
						<span slot="label" class="tab-header">Analysis</span>
						<el-row>
							<el-col :span="12" :offset="6">
								<div class="analysis_head">
									...
									>
										<p>
											In this module,HUSCH provide the
											gene set enrichement analysis(GSEA),
											cell-cell interaction(CCI) and
											Transcription factors(TF) analysis.
											Click the label, and the results
											will show below.
										</p>
									</div>
								</div>
							...
							>
								...
								<el-collapse-item>
									...
									>
										...
										<el-collapse-item>
											<template slot="title"
												>&emsp;&emsp;--Celltype-level</template
											>
											<el-select
												v-model="value"
												placeholder="Celltype"
					...
					<el-tab-pane>
						...
						<el-row :span="24">
							<el-card id="download">
								...
								<el-button type="primary" round @click="alert"
									>Expression Matrix</el-button
								>
								<!-- </el-col :span="4"> -->
								<!-- <el-col> -->
