	...
	<div id="annotation" style="color: rgb(33, 56, 50) !important">
		...
		<el-row>
			<el-col :span="24" style="padding=10px">
				<p style="font-weight: bold">
					<strong>
						<a
							href="https://selina.readthedocs.io/en/latest/index.html"
							>SELINA</a
						></strong
					>
					is a deep learning-based framework for single cell
					assignment with multiple references.
				</p>
			</el-col>
		</el-row>
		<el-card class="anno">
			...
			<el-row style="align-items: center">
				...
				<el-row type="flex" style="align-items: center">
					...
					<el-col :span="4" v-if="type_value == 'plain'">
						<el-select
							v-model="separator_value"
							placeholder="Tab/Space/Comma"
						>
							<el-option
				...
				<el-row type="flex" style="align-items: center">
					...
					<el-col :span="4">
						<el-select
							v-model="idtype_value"
							placeholder="Symbol/Ensembl"
						>
							<el-option
					...
					<el-col :span="4">
						<el-select
							v-model="assembly_value"
							placeholder="GRCh38/37"
						>
							<el-option
			...
			<el-row type="flex" style="align-items: center">
				...
				<el-col :span="4" v-if="mode_value == 'single'">
					<el-input
						v-model="npc"
						placeholder="Dimensions after PCA"
					></el-input>
				</el-col>
				<el-col :span="4" style="color: rgb(33, 56, 50)">
					<p>Email:</p>
		...
		<el-row>
			<el-col :span="4" :offset="20">
				<el-button @click="drawer = true" type="primary" style="margin-left: 16px;" circle>Help</el-button>
			</el-col>
		</el-row>
  ...
  >
		...
		<div id="Format">
			...
			<p>
				...
				<code>plain</code>, <code>h5</code> and <code>mtx</code>. You
				can find detail information in
				<a
					class="doclink"
			...
			<p>
				...
				<code>.tar.gz</code> files for time saving. You need to compress
				the original file. Noted that the compressed file should have
				same prefix with the original file name (eg :
				<code>tar -zcvf Query.txt.tar.gz Query.txt</code>).
			</p>
			<br />
			<p>
				<b>Expression level:</b> It depends on the expression level of
				your matrix uploaded, choose from single-cell level or cluster
				level.
			</p>
			<br />
			<p>
				<b>Matrix format:</b> It depends on which format your input file
				is (only need when expression level is 'single').
			</p>
			<br />
			<h3>Parameters</h3>
			<br />
			<p>
				...
				depends on the condition your input is. For tissue input, we
				have trained MADA models for 35 kinds of tissues, five of which
				also have correspoding disease model(Intestine, Pancreas, Skin,
				Lung, Liver). You can choose tissue model based on your data
				source.
			</p>

			<br />
			<p>
				<b>Gene:</b> Type of gene name, <code>symbol</code> for gene
				symbol and <code> ensembl</code> for ensembl id.
			</p>
			<br />
			<p>
			...
			<br />
			<p>
				<b>Separator:</b> It depends on which delimiters to separate
				text strings in your input (only need when input format is
				'plain').
			</p>
			<br />
			<p>
				<b>Barcode:</b> Upload the barcode file (required for the input
				format of 'mtx').
			</p>
			<br />
			<p>
				<b>Feature:</b> Upload the feature file (required for the input
				format of 'mtx').
			</p>
			<br />
			...
			<br />
			<p>
				<b>Clustering resolution:</b> Resolution for the clustering
				process.
			</p>
			<br />

			<p>
				<b>Email Address:</b> We will send you annotation results after
				things done.
			</p>
			<br />
			...
			<p>
				...
				<code>plain</code> for format and <code>Pancreas</code> for
				tissue. We only kept only has 400 cells in example file to avoid
				network congestion. To ensure preprocess module works,
				we recommend you choose PC number smaller than <code>5</code>.
			...
			<li>
				The data will be deleted after processing, please don't worry
			...
			<li>
				Due to the limit of computational resource, it will take a while
				to get results for large dataset. If you can not find result
				email in your normal box, it is worth checking in your spam or
				junk mail section.
			</li>
		</div>
		</el-drawer>
